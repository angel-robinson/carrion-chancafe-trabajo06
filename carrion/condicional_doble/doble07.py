...
#si el monto que gasto en menor que s/.50 se imprime:"usted perdio la oportunidad de ganarse una caja de lapiceros pilot "
else:
    print("usted perdio la oportunidad de ganarse una caja de lapiceros pilot ")
